...
<!--===============================================================================================-->	
	<link rel="icon" type="frontend/login/image/png" href="frontend/login/images/icons/favicon.ico"/>
<!--===============================================================================================-->
			...
			<div class="wrap-login100">
			 ...
			 @if (Session::has('status'))
				 ...
				 @if (count($errors)>0)
                  ...
                  @endif
				<form class="login100-form validate-form" action="{{URL::to('/createCompte')}}" method="POST">
					{{csrf_field()}}
                    <a href="{{URL::to('/')}}">
