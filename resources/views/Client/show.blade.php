    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
						...
						<li><a href="/sele_cat/{{$category->category_name}}" class="{{(request()->is('sele_cat/'.$category->category_name) ? 'active':'')}}">{{$category->category_name}}</a></li>
						@endforeach
          ...
          <div class="col text-center">
            <div class="block-27">
              <ul>
                ...
                <p class="active"><span>{{$products->links()}}</span></p>
